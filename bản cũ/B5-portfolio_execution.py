...
if __name__ == "__main__":
    ...
    if regime.is_risk_on():
        ...
        if not portfolio.empty:
            ...
            print(f"- Quản trị: Stop-loss tham chiếu {CONFIG['STOP_LOSS_PCT']*100:.0f}% từ điểm mua;")
            print("  với mã bị gắn cờ 'Cảnh_báo_thanh_khoản(proxy)', cân nhắc nới biên độ hoặc")
            print("  dùng lệnh giới hạn để giảm trượt giá khi cắt lỗ.")
